...
<body>
  ...
  <div class="Daff" id="Daff">
    <form method="POST" action="../../actions/users/store.php">
      ...
      <p id="error" style="color:red; display:none; margin-top: -20px;">⚠ Password dan Konfirmasi Password tidak sama!
      </p>
    ...
    <a
      href="https://accounts.google.com/v3/signin/identifier?authuser=0&continue=https%3A%2F%2Fmyaccount.google.com%2F%3Futm_source%3Dsign_in_no_continue%26pli%3D1&ec=GAlAwAE&hl=en&service=accountsettings&flowName=GlifWebSignIn&flowEntry=AddSession&dsh=S236010297%3A1747183762660966">
  ...
  <div class="daftars">
    ...
    <a href="Login.php">
      <p style="color: red; text-decoration: none;">Login Kembali</p>
    </a>
  </div>
